...
@section('title', 'เพิ่มบทความสุขภาพใหม่ - GoFit')
...
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center">
        <h1 class="mt-4">เพิ่มบทความสุขภาพใหม่</h1>
        <div>
    ...
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item active">เพิ่มบทความใหม่</li>
    </ol>
    ...
    <form id="article-form" action="{{ route('admin.health-articles.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-lg-8">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('excerpt') is-invalid @enderror" id="excerpt" name="excerpt" rows="3" maxlength="255" required>{{ old('excerpt') }}</textarea>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="seo-preview">
                                    <div class="seo-preview-title" id="seo-preview-title">ชื่อบทความจะแสดงที่นี่ - GoFit</div>
                                    <div class="seo-preview-url" id="seo-preview-url">gofit.app/articles/example-slug</div>
                                    <div class="seo-preview-description" id="seo-preview-description">คำอธิบายบทความจะแสดงที่นี่ ซึ่งจะมีประมาณ 1-2 บรรทัด ขึ้นอยู่กับความยาวของเนื้อหา...</div>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        function updateSeoPreview() {
            const title = $('#meta_title').val() || $('#title').val() || 'ชื่อบทความจะแสดงที่นี่';
            const slug = $('#slug').val() || 'example-slug';
            const description = $('#meta_description').val() || $('#excerpt').val() || 'คำอธิบายบทความจะแสดงที่นี่...';
