...
<style>
    ...
    #name-container .invalid-feedback-icon {
...
<div class="container">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form action="{{ route('admin.rewards.store') }}" method="POST" enctype="multipart/form-data" id="reward-form" novalidate>
                @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <div class="field-container">
                                <textarea class="form-control @error('description') is-invalid @enderror"
                                    ...
                                    data-error-message="กรุณาระบุคำอธิบายรางวัล">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group has-validation">
                                    <input type="number" class="form-control @error('points_required') is-invalid @enderror"
                                        id="points_required" name="points_required" value="{{ old('points_required', 100) }}" min="1" required
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group has-validation">
                                    <input type="number" class="form-control @error('quantity') is-invalid @enderror"
                                        id="quantity" name="quantity" value="{{ old('quantity', 10) }}" min="0" required
                ...
                <div class="d-flex justify-content-end mt-4">
                    ...
                    <button type="submit" class="btn btn-primary" id="submit-btn">
                        <i class="fas fa-plus me-1"></i> เพิ่มรางวัล
                    </button>
                </div>
            </form>
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // ตรวจสอบค่าเริ่มต้นของฟิลด์ทั้งหมด
        fields.forEach(field => {
            validateField(field);
        });
    });
